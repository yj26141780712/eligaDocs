...
{
    "step": 1281, //跑步步数 0位小数
    "time": 627,//跑步时间 s 0位小数
    "cosume": 77.3, //消耗热量 kcal 2位小数
    "modeId": 0, //训练模式ID
    "endTime": "",//训练结束时间 2021-08-23 08:43:00
    "avgSpeed": "6.0", //平均速度 km/h 1位小数
    "dataType": 0, //0训练1测试
    "distance": 1.03,//跑步距离 km 2位小数
    "modeName" : "", //训练模式
    "startTime": "", //开始训练时间 2021-08-23 08:43:00
    "avgStepFreq": 122 //平均步频 spm 0位小数
}
```
参数说明:
| 字段 | 说明                             |
...
```json
{
    ...
    "startTime": "",//开始训练时间 2021-08-23 08:43:00
    "endTime": "",//训练结束时间 2021-08-23 08:43:00
    "time": 393, //骑行时间 s 0位小数
    "distance": 0.21, //骑行距离 km 2位小数
    "cosume": 14.40, //消耗热量 kcal 2位小数
    "avgRotatSpeed": 1, //平均转速
    "avgSpeed": "1.9", //平均速度 km/h 1位小数
    "avgPower": 15.2, //平均功率 W
}
```
参数说明:
| 字段 | 说明                             |
...
[同T200](/third/deviceDataJson.html#t200-%E7%AB%8B%E5%BC%8F%E5%8D%95%E8%BD%A6)
